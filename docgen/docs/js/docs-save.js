...
docsApp.controller.DocsController = function($scope, $location, $window, $http, sections) {
  ...
  $scope.oFiles = [
     {name:'Admin.htm        ',locn:'apps',type:'admin sys',desc:'Admin application page'}
    ,{name:'Admin.js         ',locn:'apps',type:'admin sys',desc:'Admin application support'}
    ,{name:'AppsBase.htm     ',locn:'apps',type:'sys'      ,desc:'Standard Templates'}
    ,{name:'Chqs.htm         ',locn:'apps',type:'chqs'     ,desc:'Cheque writer application page'}
    ,{name:'Chqs.js          ',locn:'apps',type:'chqs'     ,desc:'Cheque writer application  support'}
    ,{name:'Deps.css         ',locn:'apps',type:'deps'     ,desc:'Deposit application css'}
    ,{name:'Deps.htm         ',locn:'apps',type:'deps'     ,desc:'Deposit application'}
    ,{name:'Deps.js          ',locn:'apps',type:'deps'     ,desc:'Deposit application support'}
    ,{name:'FormCheque.htm   ',locn:'apps',type:'chqs'     ,desc:'Cheque Print page'}
    ,{name:'FormCheque.js    ',locn:'apps',type:'chqs'     ,desc:'Cheque Print page support'}
    ,{name:'FormDeposit.htm  ',locn:'apps',type:'deps'     ,desc:'Deposit Print page'}
    ,{name:'FormDeposit.js   ',locn:'apps',type:'deps'     ,desc:'Deposit Print page support'}
    ...
    ,{name:'FormEnvelope.js  ',locn:'apps',type:'deps'     ,desc:'Envelope Print page support'}
    ,{name:'LAB.js           ',locn:'apps',type:'sys'      ,desc:'deferred loader'}
    ,{name:'RIO.js           ',locn:'apps',type:'sys'      ,desc:'API implemmentation'}
    ...
    ,{name:'TablesUser.css   ',locn:'apps',type:'admin sys',desc:'User css file'}
    ,{name:'TablesUser.js    ',locn:'apps',type:'admin sys',desc:'User Table Definition'}
  ];
